...
* Description: This class is used with JSF for accessing data
* Class: SpriteController{}
* Method: SpriteController(), getSelected(), getFacade(), getPagination(),
*         prepareList(), prepareView(), prepareCreate(), create(), prepareEdit(),
*         update(), destroy(), destroyAndView(), preformDestroy(), updateCurrentItem(), 
*         getItems(), recreateModel(), recreatePagination(), next(), previous(), 
*         getItemAvailableSelectMany(), getItemsAvailableSelectOne(), getSprite(), 
*         SpriteControllerConverter()
*************************************************************************************/
...
import jsfSprite.util.JsfUtil;
import jsfSprite.util.PaginationHelper;
